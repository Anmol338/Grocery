                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="2" placeholder="Write Category Description"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ $category->description }}</textarea>
                        @error('description')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6 flex">
                        ...
                        <span class="ml-5"><input type="checkbox" name="status"
                                {{ $category->status == true ? 'checked' : '' }} /></span>
                        @error('status')
                            <span class="text-red-500">{{ $message }} </span>
                        @enderror
                    </div>
