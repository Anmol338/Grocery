<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-6 py-2.5 lg:py-6.5">
        <a href="{{ route('dashboard') }}">
            <div class="w-50 h-15 flex justify-around items-center gap-2 lg:w-60">
                <img class="w-ful h-full object-fill" src="https://static.vecteezy.com/system/resources/previews/023/478/820/non_2x/shopping-cart-logo-design-or-trolley-icon-vector.jpg" alt="Logo">
                <span class="text-base text-bold text-white lg:text-xl">GroceriesStockist</span>
            </div>
        </a>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-6">
                    <!-- Menu Item Dashboard -->
                    <li x-data="{ selected: '' }">
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('dashboard') }}" :class="page === 'ecommerce' && '!text-white'">eCommerce
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                        ...
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M10 1.66667C8.15908 1.66667 6.37467 2.36899 5.05025 3.69342C3.72583 5.01784 3.0235 6.80225 3.0235 8.64317C3.0235 10.4841 3.72583 12.2685 5.05025 13.593C6.37467 14.9174 8.15908 15.6198 10 15.6198C11.841 15.6198 13.6254 14.9174 14.9498 13.593C16.2743 12.2685 16.9766 10.4841 16.9766 8.64317C16.9766 6.80225 16.2743 5.01784 14.9498 3.69342C13.6254 2.36899 11.841 1.66667 10 1.66667ZM10 0.833333C12.2091 0.833333 14.2922 1.7375 15.7426 3.18795C17.1931 4.63839 18.0973 6.72154 18.0973 8.93067C18.0973 11.1398 17.1931 13.2229 15.7426 14.6734C14.2922 16.1238 12.2091 17.028 10 17.028C7.79083 17.028 5.70767 16.1238 4.25723 14.6734C2.80679 13.2229 1.90263 11.1398 1.90263 8.93067C1.90263 6.72154 2.80679 4.63839 4.25723 3.18795C5.70767 1.7375 7.79083 0.833333 10 0.833333ZM10 5.89267C8.8375 5.89267 7.78417 6.23167 6.99833 6.84517C6.2125 7.45867 5.75333 8.29333 5.66667 9.21567H14.3333C14.2467 8.29333 13.7875 7.45867 13.0017 6.84517C12.2158 6.23167 11.1625 5.89267 10 5.89267ZM10 4.72267C11.4425 4.72267 12.7633 5.22383 13.7625 6.15267C14.7617 7.0815 15.3463 8.34667 15.4467 9.68267H4.55333C4.65375 8.34667 5.23833 7.0815 6.2375 6.15267C7.23667 5.22383 8.5575 4.72267 10 4.72267Z"
                                fill="" />
                        </svg>
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            ...
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M16 13V11H7V7H11L5 1L-1 7H3V11H2C0.9 11 0 11.9 0 13V19C0 20.1 0.9 21 2 21H7C8.1 21 9 20.1 9 19V17H16V15H9V13H16ZM22 3V21C22 22.1 21.1 23 20 23H16V21H20V3H16V1H20C21.1 1 22 1.9 22 3Z"
                                    fill="" />
                            </svg>
