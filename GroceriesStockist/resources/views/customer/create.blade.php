        ...
        <div class="mt-5 mx-5 container lg:w-1/2 lg:mx-auto border-2 border-solid border-graydark">
            <form action="{{ url('customer/create') }}" method="POST">
                ...
                <div class="mt-5 flex items-center justify-center">
                    <h1 class="flex text-black text-bold text-lg dark:text-white dark:text-bold">Add New Customer</h1>
                </div>
                ...
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter Customer Full Name"
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter Customer Email"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                            autofocus />
                        @error('email')
                            <span class="text-red-500">{{ $message }}</span>
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="contact" value="{{ old('contact') }}" placeholder="Enter Customer Contact"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                            autofocus />
                        @error('contact')
                            <span class="text-red-500">{{ $message }}</span>
